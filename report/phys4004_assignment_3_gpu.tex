...
\begin{figure}[h]
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      , scale = 1.0
      , title = {
        Comparison of CPU and GPU-CUDA GOL Scaling Performance
      }
      , grid = major
      , xmode = log
      , ymode = log
...
timing data) are shown in \autoref{tab:cuda-performance} and the timing data is
plotted in \autoref{fig:cuda-timing}.
...
\begin{figure}[h]
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      , scale = 1.0
      , title = {
        Comparison of CPU and GPU-OpenACC GOL Scaling Performance
      }
      , grid = major
      , xmode = log
      , ymode = log
